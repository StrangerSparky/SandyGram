...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"SandyGram.SandyGramDesktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"SandyGram.SandyGramDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"SandyGram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"SandyGram Desktop/SandyGram.lnk"_q;
	const auto old = u"SandyGram for Windows/SandyGram.lnk"_q;
